...
public class DriverControladorBiblioteca
{
	...
	public static void main(String args[]) throws IOException
	{
		...
		ControladorBiblioteca controlBiblio = new ControladorBiblioteca(nombre, clasifi);
		...
		while(! exit)
		{
			...
			switch(opcion)
			{
				...
				case 10:
					System.out.println("Pon un nombre de la clasificacion >> " + NEW_LINE);
					nombre_c = (buffer.readLine());
					clasifi = new Clasificacion(nombre_c);
					controlBiblio.setClasificacion(clasifi);
					break;

				case 11:
					System.out.println("Introducid el identificador del libro >> ");
					id = (Integer.parseInt(buffer.readLine()));
					System.out.println("Introducid el nombre del tema >> ");
					String nombreTema = (buffer.readLine());
					controlBiblio.anadirTemaLibro(id, nombreTema);
	...
	private static void menu()
	{
        ...
        System.out.println("9) Consultar el nombre de la clasificacion actual");
        System.out.println("10) Asignar una nueva clasificacion");
        System.out.println("11) Anadir tema");
